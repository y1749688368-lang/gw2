...
HackGUI::HackGUI(Hack& hack) : m_hack(hack), m_rebinding_hotkey_id(HotkeyID::NONE) {
    ...
    m_hotkeys = {
        {HotkeyID::SAVE_POS1,             "Save Position1",   Constants::Hotkeys::KEY_SAVEPOS1,         HotkeyTriggerType::ON_PRESS, [](Hack& h, bool) { h.savePosition1(); }},
        {HotkeyID::LOAD_POS1,             "Load Position1",   Constants::Hotkeys::KEY_LOADPOS1,         HotkeyTriggerType::ON_PRESS, [](Hack& h, bool) { h.loadPosition1(); }},
        {HotkeyID::SAVE_POS2,             "Save Position2",   Constants::Hotkeys::KEY_SAVEPOS2,         HotkeyTriggerType::ON_PRESS, [](Hack& h, bool) { h.savePosition2(); }},
        {HotkeyID::LOAD_POS2,             "Load Position2",   Constants::Hotkeys::KEY_LOADPOS2,         HotkeyTriggerType::ON_PRESS, [](Hack& h, bool) { h.loadPosition2(); }},
        {HotkeyID::SAVE_POS3,             "Save Position3",   Constants::Hotkeys::KEY_SAVEPOS3,         HotkeyTriggerType::ON_PRESS, [](Hack& h, bool) { h.savePosition3(); }},
        {HotkeyID::LOAD_POS3,             "Load Position3",   Constants::Hotkeys::KEY_LOADPOS3,         HotkeyTriggerType::ON_PRESS, [](Hack& h, bool) { h.loadPosition3(); }},
        ...
        {HotkeyID::MAP_LOAD,             "Mapload",         Constants::Hotkeys::MapLoad,             HotkeyTriggerType::ON_PRESS,  [](Hack& h, bool) { h.Maploadposition(); }},
        {HotkeyID::MAP_CREATE,           "Mapcreate",       Constants::Hotkeys::MapCreate,             HotkeyTriggerType::ON_PRESS,  [](Hack& h, bool) { h.Mapcreateposition(); }},
    };
...
void HackGUI::RenderActionsSection() {
    if (ImGui::CollapsingHeader("Actions", ImGuiTreeNodeFlags_DefaultOpen)) {
        ...
        if (ImGui::Button("Save Position1", ImVec2(button_width, 0))) { m_hack.savePosition1(); }
        ImGui::SameLine();
        if (ImGui::Button("Load Position1", ImVec2(-1.0f, 0))) { m_hack.loadPosition1(); } // Fill remaining
        ImGui::Spacing();
        if (ImGui::Button("Save Position2", ImVec2(button_width, 0))) { m_hack.savePosition2(); }
        ImGui::SameLine();
        if (ImGui::Button("Load Position2", ImVec2(-1.0f, 0))) { m_hack.loadPosition2(); } // Fill remaining
        ImGui::Spacing();
        if (ImGui::Button("Save Position3", ImVec2(button_width, 0))) { m_hack.savePosition3(); }
        ImGui::SameLine();
        if (ImGui::Button("Load Position3", ImVec2(-1.0f, 0))) { m_hack.loadPosition3(); } // Fill remaining
        ImGui::Spacing();
    }
}
