...
namespace Constants {
    ...
    namespace Hotkeys {
        ...
        constexpr int KEY_SAVEPOS1 = VK_F5;          // F5
        constexpr int KEY_LOADPOS1 = VK_F6;          // F6
        constexpr int KEY_SAVEPOS2 = VK_F5;          // F5
        constexpr int KEY_LOADPOS2 = VK_F6;          // F6
        constexpr int KEY_SAVEPOS3 = VK_F5;          // F5
        constexpr int KEY_LOADPOS3 = VK_F6;          // F6
        ...
        constexpr int MapLoad = VK_F11;        // F11
        constexpr int MapCreate = VK_F12;        // F12
    }
