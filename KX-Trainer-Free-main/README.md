#这个是我学习c++的一份代码，实现了地图传送和地图创建的功能，你可以根据自己的喜爱来设计自己的地图传送点也可以加载别人的传送点，我后面会继续学习添加新的功能，如果给我一个全传奇全dlc的账号玩玩的话也许我就没时间去开发了，总之这是面向学习的代码开发，感谢前人的智慧，并无利益交换，完全免费，如果存在侵权请联系我删除，我大概一个月看一次github，新dlc永恒愿景的箱子点位可以验证功能是否正常，创建自己地图需要有对应的地图模板，我也会发出来
